...
sudo pip install --upgrade jaxlib==0.1.67 jax==0.2.12 ray==1.2.0 fabric dataclasses optax==0.0.6 git+https://github.com/deepmind/dm-haiku tqdm cloudpickle smart_open[gcs] einops func_timeout